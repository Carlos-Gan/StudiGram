  ...
  return (
    <Form {...form}>
      <div className="flex flex-col items-center px-4">
        ...
        <h2 className="font-bold text-2xl sm:text-3xl text-center pt-5">
          Inicio de sesión
        </h2>
        <p className="text-gray-500 text-light text-center pt-5">
          Bienvenido, Ingresa tus datos para ingresar
        </p>
        <form
          ...
          <p className="text-regular text-light-2 text-center mt-2 py-3">
            ...
            <Link
              to="/sign-up"
              className="text-blue-500 font-semibold">   Registrate</Link>
          </p>
        </form>
      </div>
    </Form>
